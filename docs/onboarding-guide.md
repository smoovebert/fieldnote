# Fieldnote Onboarding Guide

A quick-start guide for qualitative researchers using Fieldnote.

## The First 10 Minutes

_Start with the sample, then make a real project_

![Fieldnote sign-in](../output/playwright/fieldnote-flow-pass.png)
...
> Good first goal: import one interview, code three useful passages, then export a tiny report.

## Organize And Code

_Bring in sources, then stay close to the text_

![Fieldnote workspace](../output/playwright/fieldnote-desktop.png)
...
_Turn first-pass coding into an analyzable project_

![Fieldnote coded workspace](../output/playwright/fieldnote-nvivo-inspired.png)
...
> Classify makes comparison possible. Without cases and attributes, Analyze can still find evidence, but it cannot compare groups very well.

## Analyze Is A Question Workspace

_Every number should lead back to evidence_
...
> Best habit: when a table cell has a number, click it and inspect the excerpts behind it.

## Report And Export

_Move from analysis to shareable evidence_
...
_Protect the work before doing big changes_
...
_Optional suggestions, never silent changes_
...
> Rule of thumb: AI can help draft language, but the researcher decides what becomes project data.
